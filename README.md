...
- *Main deadlines*:
  1. [Group formation](#project-discussion): Jan 25th
  2. [Project plan](#project-discussion): Mar 6th
  3. [Preliminary draft](#project-discussion): Apr 28th
  4. [Final submission](#project-discussion): May 8th
...
One important note. Getting a project ready in ~14 weeks is **difficult**, and **you won't be able to "wing it"**. Please reach out to me if you're experiencing roadblocks. The earlier you do this, the more time we'll have to troubleshoot.
...
1. An introduction outling: motivation, research question, data, methodology, results.
...
- Asset Pricing and Fiscal Capacity
- Impacts of AI 
...
## Podcasts
+ [*Odd lots*](https://www.bloomberg.com/oddlots). More of a finance/actualities kind of podcast, but discusses many topics of interest to economists.

+ [*Econtalk*](https://www.econtalk.org/). This podcast features interviews with most big names in Economics, and goes back almost two decades (hence the period surrounding the 07-09 GFC/great recession). Given the enormous number of episodes, I suggested going to the list of episodes and searching for some topics or names you may be familiar with (e.g., Piketty, Chetty, Saez, Friedman, Lucas, etc.). 
...
- [NBER working paper series](https://www.nber.org/papers). This is a good way to be on top of how academics are thinking of current issues. Many of these papers end up published in top academic journals. I sign up for weekly emails (with topic filters) and I recommend all of you do it as well. 
